                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: _buildStatusCard(
                              'Jumlah K/L/P yang Perlu Ditingkatkan Level Maturitas SPIP',
                              '350',
                              '(64,6%)',
                              Color(0xFF4d4c7d),
                              Colors.white,
                          ...
                          child: Column(
                            children: [
                              Flexible(
                                ...
                                children: [
                                  _buildStatusCard(
                                      'Jumlah K/L/P yang Perlu Peningkatan Efektivitas dan Efisiensi',
                                      '300',
                                      '(65.4%)',
                                      Color(0xFF04BFBF),
                                      Color(0xFF056674),
                                  ...
                                  Flexible(
                                    child: Column(
                                      children: [
                                        _buildStatusCard(
                                            'Jumlah K/L/P yang Perlu Ditingkatkan Akuntabilitas Keuangan',
                                            '250',
                                            '(55.4%)',
                                            Color(0xFFffbb91),
                                            Colors.brown,
                                            ...
                                            Color(0xFFff7272)),
                                        _buildStatusCard(
                                            'Jumlah K/L/P yang Perlu Peningkatan Pengamanan atas Aset',
                                            '57',
                                            '(15.4%)',
                                            Color(0xFF28df99),
                                            Color(0xFF056674),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          width: double.infinity,
                          child: _buildStatusCard(
                              'Jumlah K/L/P yang Perlu Peningkatan Kepatuhan Terhadap Peraturan',
                              '35',
                              '(6,5%)',
                              Color(0xFFA0A603),
                              Color(0xFF2b580c),
